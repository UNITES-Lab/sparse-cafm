...
SRC_DIR = "/playpen/mufan/levi/tianlong-chen-lab/material-super-resolution/data/raw-data/11-19-24/1. MoS2 on SiO2-Si"
EXT = "tiff"
TRAIN_SPLIT = "train"
VAL_SPLIT = "val"
...
class SiliconDataset(Dataset):
    """
    Dataset class for MoS2 samples collected on a Silicon substrate.
