...
# SURROGATE_FP="__exps__/expert-surrogates/2025-02-28_11-13-44_coverage_percentage_surrogate/coverage_percentage_surrogate_best_older_surrogate.pth"

# EXP_ROOT_DIR="__exps__/substrates/mos2-sef/2x"
# LOGS_DIR=__exps__/__logs__
# EXP_NAME="metric=coverage-percentage-ds=mos2-sef-[y]-BS=8-opt=Adam-lr=1e-5"
